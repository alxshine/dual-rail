...
plt.scatter(indices[np.isin(pt,ldr)], pt[np.isin(pt,ldr)], s=1, label='Load instructions')
plt.scatter(indices[np.isin(pt,mov)], pt[np.isin(pt,mov)], s=1, label='Move instructions')
