...
indices = np.arange(pt.shape[0])[pt<=balanced_ashr[1]]
pt = pt[indices]
...
plt.axhspan(balanced_srem[0],balanced_srem[1],label='balanced_srem',color='C12',alpha=0.2)
plt.axhspan(balanced_shl[0],balanced_shl[1],label='balanced_shl',color='C13',alpha=0.2)
plt.axhspan(balanced_lshr[0],balanced_lshr[1],label='balanced_lshr',color='C14',alpha=0.2)
plt.axhspan(balanced_ashr[0],balanced_ashr[1],label='balanced_ashr',color='C15',alpha=0.2)
